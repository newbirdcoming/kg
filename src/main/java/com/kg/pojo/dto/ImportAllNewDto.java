...
public class ImportAllNewDto {
    ...
    @TableField(value = "participant_location")
    @ExcelImport("参与者地点")
    ...
    @TableField(value = "collaboration_network_location")
    @ExcelImport("协作网络地点")
    private String collaborationNetworkLocation;
