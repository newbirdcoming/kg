...
/**
 * 
 * @TableName appeal_to_location
 */
@TableName(value ="appeal_to_location")
@Data
public class AppealToLocation implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        AppealToLocation other = (AppealToLocation) that;
